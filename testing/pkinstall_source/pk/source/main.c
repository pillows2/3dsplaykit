...
int main()
{
	...
	while (aptMainLoop())
	{
		...
		if (screen == 0) {
			...
			printStatement("6. SCRTool", 10);
			printStatement("7. CTRXplorer", 11);
			...
			if ((hidKeysDown() & KEY_A) & (cursor == 5)) {
				...
				mkdir("/3ds/SCRTool (WIP, not working)", 0777);
				...
				downloadToFile("https://github.com/pillows2/pkinstall/blob/master/download/CTRXplorer.3dsx?raw=true", "/3ds/CTRXplorer/CTRXplorer.sdmh");
				resetScreen();
				consoleSelect(&topScreen);
				...
				downloadToFile("https://github.com/pillows2/pkinstall/blob/master/download/ctrmus.3dsx?raw=true", "/3ds/CTRMUS/CTRMUS.3dsx");
				resetScreen();
			} else if ((hidKeysDown() & KEY_A) & (cursor == 11)) {
				mkdir("/3ds/", 0777);
				mkdir("/3ds/CTRXplorer/", 0777);
				downloadToFile("https://github.com/pillows2/pkinstall/blob/master/download/CTRXplorer.3dsx?raw=true", "/3ds/CTRXPlorer/CTRXplorer.3dsx");
				resetScreen();
			}
